...
# ✅ 2. 台東縣所有鄉鎮市中心座標
area_keywords = [
    ("台東市", "22.7494,121.1444", "台東縣"),
    ("成功鎮", "23.0997,121.3822", "台東縣"),
    ("關山鎮", "23.0447,121.1617", "台東縣"),
    ("卑南鄉", "22.7775,121.1075", "台東縣"),
    ("大武鄉", "22.3536,120.8978", "台東縣"),
    ("太麻里鄉", "22.6181,121.0097", "台東縣"),
    ("東河鄉", "23.1247,121.2978", "台東縣"),
    ("長濱鄉", "23.3183,121.4542", "台東縣"),
    ("鹿野鄉", "22.9078,121.1242", "台東縣"),
    ("池上鄉", "23.1264,121.2175", "台東縣"),
    ("綠島鄉", "22.6722,121.4892", "台東縣"),
    ("海端鄉", "23.1033,121.1706", "台東縣"),
    ("延平鄉", "22.8533,121.1236", "台東縣"),
    ("金峰鄉", "22.5681,120.9647", "台東縣"),
    ("達仁鄉", "22.4178,120.8811", "台東縣"),
    ("蘭嶼鄉", "22.0403,121.5514", "台東縣"),
]
...
# ✅ 8. 將結果寫入 CSV 檔案
def save_to_csv(data, filename="taitung_beauty_stores.csv"):
    try:
...
if __name__ == '__main__':
    print("🚀 開始搜尋台東縣的美容店家資料... (優化版)")
    print("💅 搜尋類型：美容、美甲、美睫、指甲、睫毛、採耳、耳燭、熱蠟、除毛、護膚等")
    print("📍 涵蓋區域：台東縣 (所有鄉鎮市)")
