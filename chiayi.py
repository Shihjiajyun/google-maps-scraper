...
area_keywords = [
    # 嘉義市
    ("東區", "23.4801,120.4560", "嘉義市"),
    ("西區", "23.4752,120.4356", "嘉義市"),

    # 嘉義縣
    ("太保市", "23.4581,120.3246", "嘉義縣"),
    ("朴子市", "23.4640,120.2477", "嘉義縣"),
    ("布袋鎮", "23.3807,120.1511", "嘉義縣"),
    ("大林鎮", "23.6049,120.4715", "嘉義縣"),
    ("民雄鄉", "23.5515,120.4251", "嘉義縣"),
    ("溪口鄉", "23.5897,120.3523", "嘉義縣"),
    ("新港鄉", "23.5557,120.3456", "嘉義縣"),
    ("六腳鄉", "23.4602,120.2589", "嘉義縣"),
    ("東石鄉", "23.4536,120.1572", "嘉義縣"),
    ("義竹鄉", "23.3642,120.1815", "嘉義縣"),
    ("鹿草鄉", "23.3997,120.2961", "嘉義縣"),
    ("水上鄉", "23.4377,120.3990", "嘉義縣"),
    ("中埔鄉", "23.4456,120.5380", "嘉義縣"),
    ("竹崎鄉", "23.5285,120.5530", "嘉義縣"),
    ("梅山鄉", "23.5835,120.5583", "嘉義縣"),
    ("番路鄉", "23.4715,120.5935", "嘉義縣"),
    ("大埔鄉", "23.3077,120.6475", "嘉義縣"),
    ("阿里山鄉", "23.5123,120.8127", "嘉義縣"),
]
...
# ✅ 8. 將結果寫入 CSV 檔案
def save_to_csv(data, filename="chiayi_0711.csv"):
    try:
