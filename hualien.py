...
# ✅ 2. 花蓮縣所有鄉鎮市中心座標
area_keywords = [
    ("花蓮市", "23.9897,121.6014", "花蓮縣"),
    ("吉安鄉", "23.9631,121.5803", "花蓮縣"),
    ("新城鄉", "24.1281,121.6414", "花蓮縣"),
    ("秀林鄉", "24.1547,121.5058", "花蓮縣"),
    ("壽豐鄉", "23.8647,121.5122", "花蓮縣"),
    ("光復鄉", "23.6747,121.4219", "花蓮縣"),
    ("豐濱鄉", "23.6039,121.5172", "花蓮縣"),
    ("瑞穗鄉", "23.4997,121.3742", "花蓮縣"),
    ("富里鄉", "23.1819,121.2522", "花蓮縣"),
    ("玉里鎮", "23.3331,121.3103", "花蓮縣"),
    ("卓溪鄉", "23.3458,121.2236", "花蓮縣"),
    ("萬榮鄉", "23.7139,121.4075", "花蓮縣"),
    ("鳳林鎮", "23.7486,121.4553", "花蓮縣"),
]
...
# ✅ 8. 將結果寫入 CSV 檔案
def save_to_csv(data, filename="hualien_beauty_stores.csv"):
    try:
...
if __name__ == '__main__':
    print("🚀 開始搜尋花蓮縣的美容店家資料... (優化版)")
    print("💅 搜尋類型：美容、美甲、美睫、指甲、睫毛、採耳、耳燭、熱蠟、除毛、護膚等")
    print("📍 涵蓋區域：花蓮縣 (所有鄉鎮市)")
