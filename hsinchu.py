...
area_keywords = [
    # 新竹市
    ("東區", "24.8013,120.9714", "新竹市"),
    ("北區", "24.8186,120.9647", "新竹市"),
    ("香山區", "24.7607,120.9460", "新竹市"),

    # 新竹縣
    ("竹北市", "24.8354,121.0110", "新竹縣"),
    ("湖口鄉", "24.9007,121.0389", "新竹縣"),
    ("新豐鄉", "24.9033,120.9828", "新竹縣"),
    ("新埔鎮", "24.8383,121.0756", "新竹縣"),
    ("關西鎮", "24.7881,121.1764", "新竹縣"),
    ("芎林鄉", "24.7763,121.0866", "新竹縣"),
    ("寶山鄉", "24.7321,120.9924", "新竹縣"),
    ("竹東鎮", "24.7401,121.0868", "新竹縣"),
    ("五峰鄉", "24.5793,121.1094", "新竹縣"),
    ("橫山鄉", "24.6935,121.1526", "新竹縣"),
    ("尖石鄉", "24.6743,121.2714", "新竹縣"),
    ("北埔鄉", "24.6928,121.0672", "新竹縣"),
    ("峨眉鄉", "24.6884,121.0028", "新竹縣"),
]
...
# ✅ 8. 將結果寫入 CSV 檔案
def save_to_csv(data, filename="hsinchu_0703.csv"):
    try:
