...
# ✅ 2. 南投縣所有鄉鎮市中心座標
area_keywords = [
    ("南投市", "23.9056,120.6858", "南投縣"),
    ("草屯鎮", "23.9742,120.6828", "南投縣"),
    ("竹山鎮", "23.7567,120.6781", "南投縣"),
    ("集集鎮", "23.8264,120.7847", "南投縣"),
    ("名間鄉", "23.8500,120.6858", "南投縣"),
    ("鹿谷鄉", "23.7419,120.7581", "南投縣"),
    ("中寮鄉", "23.9056,120.7653", "南投縣"),
    ("魚池鄉", "23.8986,120.9394", "南投縣"),
    ("國姓鄉", "24.0472,120.8653", "南投縣"),
    ("水里鄉", "23.8181,120.8506", "南投縣"),
    ("信義鄉", "23.6408,120.8564", "南投縣"),
    ("仁愛鄉", "24.0139,121.1300", "南投縣"),
    ("埔里鎮", "23.9681,120.9681", "南投縣"),
]
...
# ✅ 8. 將結果寫入 CSV 檔案
def save_to_csv(data, filename="nantou_beauty_stores.csv"):
    try:
...
if __name__ == '__main__':
    print("🚀 開始搜尋南投縣的美容店家資料... (優化版)")
    print("💅 搜尋類型：美容、美甲、美睫、指甲、睫毛、採耳、耳燭、熱蠟、除毛、護膚等")
    print("📍 涵蓋區域：南投縣 (所有鄉鎮市)")
