...
# ✅ 2. 苗栗縣所有鄉鎮市中心座標
area_keywords = [
    ("苗栗市", "24.5603,120.8214", "苗栗縣"),
    ("頭份市", "24.6958,120.9019", "苗栗縣"),
    ("竹南鎮", "24.6842,120.8778", "苗栗縣"),
    ("後龍鎮", "24.6125,120.7875", "苗栗縣"),
    ("通霄鎮", "24.4900,120.6781", "苗栗縣"),
    ("苑裡鎮", "24.4414,120.6508", "苗栗縣"),
    ("卓蘭鎮", "24.3078,120.8231", "苗栗縣"),
    ("大湖鄉", "24.4189,120.8653", "苗栗縣"),
    ("公館鄉", "24.5058,120.8256", "苗栗縣"),
    ("銅鑼鄉", "24.4847,120.7836", "苗栗縣"),
    ("南庄鄉", "24.5997,121.0103", "苗栗縣"),
    ("頭屋鄉", "24.5850,120.8928", "苗栗縣"),
    ("三義鄉", "24.3833,120.7581", "苗栗縣"),
    ("西湖鄉", "24.5639,120.7450", "苗栗縣"),
    ("造橋鄉", "24.6297,120.8747", "苗栗縣"),
    ("三灣鄉", "24.6464,120.9550", "苗栗縣"),
    ("獅潭鄉", "24.5431,120.9189", "苗栗縣"),
    ("泰安鄉", "24.4689,120.9508", "苗栗縣"),
]
...
# ✅ 8. 將結果寫入 CSV 檔案
def save_to_csv(data, filename="miaoli_beauty_stores.csv"):
    try:
...
if __name__ == '__main__':
    print("🚀 開始搜尋苗栗縣的美容店家資料... (優化版)")
    print("💅 搜尋類型：美容、美甲、美睫、指甲、睫毛、採耳、耳燭、熱蠟、除毛、護膚等")
    print("📍 涵蓋區域：苗栗縣 (所有鄉鎮市)")
