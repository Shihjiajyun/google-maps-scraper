...
area_keywords = [
    ("仁愛區", "25.1276,121.7394", "基隆市"),
    ("信義區", "25.1296,121.7605", "基隆市"),
    ("中正區", "25.1411,121.7725", "基隆市"),
    ("中山區", "25.1447,121.7356", "基隆市"),
    ("安樂區", "25.1252,121.7218", "基隆市"),
    ("暖暖區", "25.0953,121.7459", "基隆市"),
    ("七堵區", "25.0990,121.7144", "基隆市"),
]
...
# ✅ 8. 將結果寫入 CSV 檔案
def save_to_csv(data, filename="keelung_0711.csv"):
    try:
