...
# ✅ 2. 宜蘭縣所有鄉鎮市中心座標
area_keywords = [
    ("宜蘭市", "24.7022,121.7378", "宜蘭縣"),
    ("羅東鎮", "24.6778,121.7706", "宜蘭縣"),
    ("蘇澳鎮", "24.5944,121.8553", "宜蘭縣"),
    ("頭城鎮", "24.8575,121.8217", "宜蘭縣"),
    ("礁溪鄉", "24.8222,121.7681", "宜蘭縣"),
    ("壯圍鄉", "24.7450,121.7753", "宜蘭縣"),
    ("員山鄉", "24.7619,121.6914", "宜蘭縣"),
    ("冬山鄉", "24.6328,121.7933", "宜蘭縣"),
    ("五結鄉", "24.6858,121.8108", "宜蘭縣"),
    ("三星鄉", "24.6542,121.6431", "宜蘭縣"),
    ("大同鄉", "24.5764,121.4847", "宜蘭縣"),
    ("南澳鄉", "24.4644,121.7019", "宜蘭縣"),
]
...
# ✅ 8. 將結果寫入 CSV 檔案
def save_to_csv(data, filename="yilan_beauty_stores.csv"):
    try:
...
if __name__ == '__main__':
    print("🚀 開始搜尋宜蘭縣的美容店家資料... (優化版)")
    print("💅 搜尋類型：美容、美甲、美睫、指甲、睫毛、採耳、耳燭、熱蠟、除毛、護膚等")
    print("📍 涵蓋區域：宜蘭縣 (所有鄉鎮市)")
